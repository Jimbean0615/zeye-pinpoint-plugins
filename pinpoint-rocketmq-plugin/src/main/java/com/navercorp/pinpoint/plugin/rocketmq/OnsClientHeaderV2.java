...
public enum OnsClientHeaderV2 {
    ...
    private interface MessageHandler {
        void setMessage(MessageExt message, OnsClientHeaderV2 key, Object value);

        String getMessage(MessageExt message, OnsClientHeaderV2 key);
    }

    private static final MessageHandler messageHandlerBase = new MessageHandler() {

        @Override
        public final void setMessage(MessageExt message, OnsClientHeaderV2 key, Object value) {
            message.putUserProperty(key.id, value.toString());
        }

        @Override
        public final String getMessage(MessageExt message, OnsClientHeaderV2 key) {
            String id = key.id;
