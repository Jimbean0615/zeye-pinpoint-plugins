 ...
 * @author 微风
 */
public enum RocketMQClientHeader {
    ...
    RocketMQClientHeader(String id) {
        this.id = id;
    }
    ...
    private interface MessageHandler {
        void setMessage(Message message, RocketMQClientHeader key, Object value);

        String getMessage(Message message, RocketMQClientHeader key);
    }

    private static final MessageHandler messageHandlerBase = new MessageHandler() {

        @Override
        public final void setMessage(Message message, RocketMQClientHeader key, Object value) {
            message.putUserProperty(key.id, value.toString());
        }

        @Override
        public final String getMessage(Message message, RocketMQClientHeader key) {
            String id = key.id;
